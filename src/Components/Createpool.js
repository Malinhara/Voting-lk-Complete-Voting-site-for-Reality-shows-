...
const handleSelectChange = (e) => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      const Competition_name= adminData.fields.Competition_name.stringValue;
      const Competition_cat= adminData.fields.Competition_cat.stringValue;
      const Competition_logo= adminData.fields.imagelogo.stringValue;
  ...
  return (
    ...
    <div style={{marginLeft:'300px',marginTop:'100px',backgroundColor:'#f3f6fd'}}>
